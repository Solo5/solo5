...
- [scripts/](../scripts/): extra tooling and scripts (mainly to support the
  _virtio_ target).
- [solo5.opam](../solo5.opam): package definitions and pkg-config files for
  integration with OPAM and MirageOS.
- [solo5-cross-aarch64.opam](../solo5-cross-arch64.opam): package definitions
  and pkg-config files for integration with OPAM and MirageOS (cross-compilation
  from amd64 to aarch64).
